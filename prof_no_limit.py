...
def solve_puzzle(state, buttons):
    solution_path = solve(state)
...
def create_gui(state):
    ...
    solve_button = tk.Button(window, text="Solve", command=lambda: solve_puzzle(state, buttons), width=10, height=2)
